...
public class App {
    ...
    public static void main(String[] args) {
        ...
        user.transactions.add(new Transaction("T011", "Entertainment", -75.00,  now - 8 * day,    "Streaming subscriptions"));
        ...
        // Utilities
        user.transactions.add(new Transaction("T015", "Utilities",     -110.00, now - 25 * day,   "Electricity + water bill"));
